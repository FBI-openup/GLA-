...
public class TestPlein {
    ...
    @Test
    public void conteneurEstPleinApresAjouts() {
    ...
    public void ajouterNouveauPlein() {
        ...
        assertDoesNotThrow(() -> C.ajouter(C1, D1));

    }

    @Test
    public void retirerElementPlein() {
    ...
    @Test
    public void redimensionnerConteneurPlein() {
        assertDoesNotThrow(() -> C.redimensionner(10));
        assertEquals(10, C.capacite());
        assertEquals(5, C.taille());
    }

    @Test
    public void modifierValeurClefExistantePlein() {
        Object Bnew = new Object();
        assertDoesNotThrow(() -> C.ajouter(A1, Bnew));
        assertEquals(Bnew, assertDoesNotThrow(() -> C.valeur(A1)));
    }
}
